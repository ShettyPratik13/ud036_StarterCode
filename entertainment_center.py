...
dark_knight = media.Movie("The Dark Knight",
                          "A vile young criminal calling himself " +
                          "the Joker throws the town into chaos",
                          "http://filmisub.com/uploads/movies" +
                          "/155/1hRoyzDtpgMU7Dz4JF22RANzQO7.jpg",
...
black_panther = media.Movie("Black Panther",
                            "T'Challa returns home to the African " +
...
pursuit_happyness = media.Movie("The Pursuit of Happyness",
                                "Chris refuses to give" +
                                " in to despair as he " +
                                "struggles to create a better life" +
                                " for himself and his son.",
                                "https://upload.wikimedia.org/wikipedia/" +
                                "en/8/81/Poster-pursuithappyness.jpg",
                                "https://www.youtube.com/watch?v=00uTFVnWJMw")


movies = [toy_story, avatar, dark_knight,
          ratatouille, black_panther, pursuit_happyness]
